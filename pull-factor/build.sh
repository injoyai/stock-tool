...
# 不同平台编译
#build_and_upload windows amd64 "" $'_windows_amd64.exe'
#build_and_upload windows arm64 "" $'_windows_arm64.exe'
build_and_upload linux amd64 "" 'pull-factor'
#build_and_upload linux arm64 "" $'_linux_arm64'
#build_and_upload linux arm 7 $'_linux_arm'
